...
func PrintTradeRoutes(trade_routes []TradeRoute) {
...
func TradeRouteMissingData(trade_routes []TradeRoute) (bool, TradeRoute) {
	empty_trade_route := TradeRoute{}
	for _, trade_route := range trade_routes {
		if trade_route.ProfitabilityRating == 0.00 {
